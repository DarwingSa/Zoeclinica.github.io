        ...
        <div className="bg-background overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-16 md:pt-40 md:pb-32 overflow-hidden">
                ...
                <div className="container px-4 text-center relative z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass border-primary/10 text-primary text-xs md:text-sm font-medium mb-6 md:mb-8 animate-fade-up">
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-6xl font-extrabold font-headline text-foreground tracking-tight mb-4 md:mb-6 leading-tight animate-fade-up delay-100">
                    ...
                    <p className="text-base md:text-xl text-muted-foreground mt-6 md:mt-8 max-w-3xl mx-auto leading-relaxed animate-fade-up delay-200">
                    ...
                    {services.map((service, index) => (
                        <div key={service.title} className="grid md:grid-cols-12 gap-8 md:gap-16 items-center mb-16 md:mb-24 last:mb-0">
                            ...
                            <div className={`md:col-span-6 relative ${index % 2 !== 0 ? 'md:order-last' : ''}`}>
                                <div className="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-glow-lg border border-border/30 bg-card p-1.5 md:p-2 group glow-border">
                                ...
                                <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 glass p-3 md:p-4 rounded-xl md:rounded-2xl shadow-glow flex items-center justify-center z-20">
                            ...
                            <div className={`md:col-span-6 mt-6 md:mt-0 ${index % 2 !== 0 ? 'md:order-first' : ''}`}>
                                <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
                                    <span className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-primary/10 to-[#2aaadd]/10 text-primary font-bold text-base md:text-lg font-headline border border-primary/20">
                                        0{index + 1}
                                    </span>
                                ...
                                <div className="bg-secondary/30 dark:bg-secondary/10 rounded-2xl md:rounded-3xl p-5 md:p-8 border border-border/50 hover:border-primary/20 transition-all duration-500">
            ...
            <section className="relative py-16 md:py-24 overflow-hidden">
                ...
                <div className="container px-4 relative z-10 text-center text-primary-foreground">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center">
                        <Button asChild size="lg" variant="secondary" className="w-full sm:w-auto shadow-2xl text-primary font-bold h-12 md:h-14 px-8 md:px-10 text-base md:text-lg hover:scale-105 transition-transform">
                            <Link href="/contacto">Agenda una Cita</Link>
                        </Button>
                        <p className="text-sm text-primary-foreground/70">o llámanos al <span className="font-bold text-white">+58 412 595 7240</span></p>
                    </div>
                </div>
            </section>
        </div>
