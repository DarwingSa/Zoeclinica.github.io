    ...
    <div className="bg-background overflow-x-hidden">
      ...
      <section id="inicio" className="relative min-h-[92vh] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-8">
          <div className="max-w-2xl space-y-6 md:space-y-8">
            {/* Tag */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass border-primary/20 text-primary text-xs md:text-sm font-semibold animate-fade-up">
            ...
            {/* Heading */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold font-headline text-foreground tracking-tight leading-[1.08] animate-fade-up delay-100">
              Cuidado experto{' '}
            ...
            {/* Subtitle */}
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground max-w-[52ch] leading-relaxed animate-fade-up delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2 animate-fade-up delay-300">
              <Button asChild size="lg" className="text-base md:text-lg h-12 md:h-14 px-6 md:px-8 shadow-glow-lg hover:shadow-glow-xl hover:translate-y-[-2px] transition-all duration-300">
                <Link href="/contacto">
                  <Phone className="mr-2 h-5 w-5" />
                  Pedir Cita Ahora
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="text-base md:text-lg h-12 md:h-14 px-6 md:px-8 hover:bg-primary/5 hover:text-primary hover:border-primary/40 transition-all duration-300">
      ...
      <section className="relative z-20 -mt-12 md:-mt-16 pb-8 md:pb-12">
        <div className="container px-4">
          <div className="glass-strong rounded-2xl md:rounded-3xl shadow-glow-lg p-6 md:p-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              {stats.map((stat) => {
                const StatIcon = stat.icon;
                return (
                  <div key={stat.label} className="flex items-center gap-3 md:gap-4 group">
                    <div className="bg-primary/10 text-primary p-2.5 md:p-3 rounded-xl group-hover:bg-primary group-hover:text-white transition-all duration-300 flex-shrink-0">
                      <StatIcon className="h-5 w-5 md:h-6 md:w-6" />
                    </div>
                    <div>
                      <p className="font-extrabold text-xl md:text-2xl text-foreground leading-none">{stat.value}</p>
                      <p className="text-[10px] md:text-xs uppercase tracking-wider font-semibold text-muted-foreground mt-0.5">{stat.label}</p>
                    </div>
                  </div>
                );
              })}
      ...
      {/* ═══════════════════════════════════════════
          SERVICES — Bento grid
          ═══════════════════════════════════════════ */}
      <section id="servicios" className="py-16 md:py-28 bg-background relative">
        <div className="container px-4">
          {/* Section header */}
          <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-5xl font-bold font-headline text-foreground mb-4 md:mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-5 lg:gap-6">
            ...
            {(() => {
              ...
              return (
                <div className="md:col-span-4 group relative bg-gradient-to-br from-primary to-[#2aaadd] rounded-3xl p-8 md:p-10 overflow-hidden min-h-[260px] flex flex-col justify-end shadow-glow-lg">
                  {/* Pattern overlay */}
                  ...
                  {/* Icon */}
                  <div className="absolute top-8 right-8 bg-white/15 backdrop-blur-sm p-4 rounded-2xl group-hover:scale-110 transition-transform duration-500">
                    <FeaturedIcon className="h-10 w-10 text-white" />
                  </div>
                  <div className="relative z-10 text-white">
                    <h3 className="font-bold text-2xl md:text-3xl mb-3 font-headline">{services[0].title}</h3>
                    <p className="text-white/80 text-base md:text-lg leading-relaxed mb-5 max-w-lg">{services[0].description}</p>
            ...
            {(() => {
              ...
              return (
                <div className="md:col-span-2 group relative bg-card/80 dark:bg-card/40 backdrop-blur-sm rounded-3xl p-6 md:p-8 border border-border/50 hover:border-primary/30 hover:shadow-glow transition-all duration-500 flex flex-col justify-between glow-border overflow-hidden min-h-[260px]">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                  <div className="bg-primary/10 text-primary rounded-2xl p-3.5 w-fit group-hover:bg-primary group-hover:text-white group-hover:shadow-glow transition-all duration-500 relative z-10">
                    <Icon2 className="h-6 w-6 md:h-7 md:w-7" />
                  </div>
                  <div className="relative z-10 mt-4">
                    <h4 className="font-bold text-lg md:text-xl mb-2 font-headline text-foreground">{services[1].title}</h4>
                    <p className="text-muted-foreground text-sm md:text-base leading-relaxed">{services[1].description}</p>
                  </div>
                </div>
              );
            })()}
            ...
            {services.slice(2).map((service) => {
              ...
              return (
                <div key={service.id} className="md:col-span-2 group relative bg-card/80 dark:bg-card/40 backdrop-blur-sm rounded-3xl p-6 md:p-8 border border-border/50 hover:border-primary/30 hover:shadow-glow transition-all duration-500 flex flex-col justify-between glow-border overflow-hidden min-h-[220px]">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                  <div className="bg-primary/10 text-primary rounded-2xl p-3.5 w-fit group-hover:bg-primary group-hover:text-white group-hover:shadow-glow transition-all duration-500 relative z-10">
                    <ServiceIcon className="h-6 w-6 md:h-7 md:w-7" />
                  </div>
                  <div className="relative z-10 mt-4">
                    <h4 className="font-bold text-lg md:text-xl mb-2 font-headline text-foreground">{service.title}</h4>
          ...
          <div className="text-center mt-10 md:mt-14">
            <Button asChild size="lg" variant="outline" className="h-12 md:h-14 px-8 text-base font-bold hover:bg-primary/5 hover:text-primary hover:border-primary/40 transition-all duration-300">
              <Link href="/servicios">
      ...
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      <section id="philosophy" className="py-16 md:py-28 bg-secondary/20 dark:bg-secondary/5 relative overflow-hidden">
        ...
        <div className="container px-4">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                <span className="text-primary font-bold tracking-wider uppercase text-xs md:text-sm mb-3 block">Nuestra Filosofía</span>
                <h2 className="text-3xl md:text-5xl font-bold font-headline text-foreground mb-4 md:mb-6">
              ...
              <div className="space-y-4 pt-2">
                {[
                  ...
                  return (
                    <div key={index} className="flex items-start gap-4 md:gap-5 p-4 md:p-5 rounded-2xl bg-card/80 dark:bg-card/40 backdrop-blur-sm shadow-sm border border-transparent hover:border-primary/20 hover:shadow-glow-sm transition-all duration-500 group border-gradient-left">
                      <div className="bg-primary/10 text-primary p-3 rounded-xl flex-shrink-0 group-hover:bg-primary group-hover:text-white transition-all duration-300">
      ...
      <section className="py-16 md:py-28 bg-background relative overflow-hidden">
        ...
        <div className="container px-4">
          <div className="text-center mb-12 md:mb-16">
            <span className="text-primary font-bold tracking-wider uppercase text-xs md:text-sm mb-3 block">Testimonios</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((testimonial) => (
              <Card key={testimonial.name} className="group bg-card/60 dark:bg-card/30 backdrop-blur-sm border border-border/50 hover:border-primary/20 shadow-sm hover:shadow-glow transition-all duration-500 p-0 h-full flex flex-col rounded-3xl overflow-hidden">
                <CardContent className="pt-8 px-6 md:px-8 flex-grow relative">
                  {/* Quote mark */}
                  <div className="text-primary/10 absolute top-6 left-6 md:left-8">
                  ...
                  <p className="text-foreground/80 mb-6 italic text-base md:text-lg leading-relaxed relative z-10 pt-10">
                    &quot;{testimonial.quote}&quot;
                  </p>
                ...
                <CardFooter className="px-6 md:px-8 pb-6 md:pb-8 border-t border-foreground/5 pt-4">
                  <div className="flex items-center gap-4">
                    <div className="w-11 h-11 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-primary to-[#2aaadd] flex items-center justify-center text-primary-foreground font-bold text-lg md:text-xl shadow-glow-sm">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="absolute bottom-10 left-[5%] w-64 h-64 bg-white/5 rounded-full blur-3xl pointer-events-none" />

        <div className="container relative z-10 text-center px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold font-headline mb-4 md:mb-6 tracking-tight text-white">
              ¿Listos para darle a tu mejor amigo{' '}
              <br className="hidden md:block" />
              el cuidado que merece?
            </h2>
            <p className="text-lg md:text-xl text-white/80 mb-8 md:mb-10 max-w-2xl mx-auto font-light leading-relaxed">
              Agenda una cita hoy y únete a la familia de Centro Veterinario Zoé.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" variant="secondary" className="font-bold h-12 md:h-14 px-8 md:px-10 text-base md:text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
                <Link href="/contacto">Agenda una Cita</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="font-bold h-12 md:h-14 px-8 md:px-10 text-base md:text-lg border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-300">
