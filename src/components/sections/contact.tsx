  ...
  return (
    <div className="bg-background">
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      <section className="relative pt-24 pb-24 md:pt-40 md:pb-48 overflow-hidden">
        ...
        <div className="absolute top-20 right-[15%] w-32 h-32 md:w-48 md:h-48 bg-white/10 rounded-full blur-xl animate-float-slow pointer-events-none" />
        <div className="absolute bottom-10 left-[10%] w-40 h-40 md:w-64 md:h-64 bg-white/5 rounded-full blur-2xl animate-float-delayed pointer-events-none" />
        <div className="absolute top-1/2 right-[5%] w-20 h-20 bg-white/10 rounded-2xl rotate-45 blur-lg animate-float pointer-events-none" />

        <div className="container text-center relative z-10 px-4 text-primary-foreground">
          <h1 className="text-3xl md:text-6xl font-extrabold font-headline mb-4 md:mb-6 tracking-tight animate-fade-up">Contáctanos</h1>
          <p className="text-base md:text-xl text-primary-foreground/80 max-w-2xl mx-auto leading-relaxed animate-fade-up delay-100">
      ...
      <section className="relative z-20 -mt-12 md:-mt-20 pb-16 md:pb-24">
        <div className="container px-4">
          <Card className="shadow-glow-xl border-none overflow-hidden rounded-2xl md:rounded-3xl">
            <CardContent className="p-0">
              <div className="grid lg:grid-cols-5">

                {/* Info Column with glassmorphism */}
                <div className="lg:col-span-2 bg-secondary/80 dark:bg-secondary/20 backdrop-blur-sm text-foreground p-6 md:p-12 flex flex-col justify-between order-last lg:order-first relative overflow-hidden">
                  {/* Decorative orb */}
                    ...
                    <ul className="space-y-6 md:space-y-8">
                      {contactInfo.map((info, index) => (
                        <li key={index} className="flex gap-4 group">
                          <div className={`bg-card dark:bg-white/5 p-2.5 md:p-3 rounded-xl shadow-sm h-fit group-hover:shadow-glow-sm transition-all duration-300 ${info.customColor ? '' : 'text-primary'}`}>
                ...
                {/* Form Column */}
                <div className="lg:col-span-3 bg-card p-6 md:p-12 lg:p-16">
                  ...
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="Tu nombre" {...field} className="bg-secondary/20 dark:bg-secondary/10 border-border/50 focus:border-primary/50 focus:bg-card transition-all duration-300 h-10 md:h-12 text-base rounded-xl" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input type="email" placeholder="tu@email.com" {...field} className="bg-secondary/20 dark:bg-secondary/10 border-border/50 focus:border-primary/50 focus:bg-card transition-all duration-300 h-10 md:h-12 text-base rounded-xl" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Motivo de tu consulta" {...field} className="bg-secondary/20 dark:bg-secondary/10 border-border/50 focus:border-primary/50 focus:bg-card transition-all duration-300 h-10 md:h-12 text-base rounded-xl" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea placeholder="Cuéntanos cómo podemos ayudarte..." className="min-h-[120px] md:min-h-[150px] bg-secondary/20 dark:bg-secondary/10 border-border/50 focus:border-primary/50 focus:bg-card transition-all duration-300 resize-none p-3 md:p-4 text-base rounded-xl" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <div className="pt-2 md:pt-4">
                        <Button type="submit" size="lg" className="w-full md:w-auto shadow-glow-lg hover:shadow-glow-xl hover:translate-y-[-2px] transition-all duration-300 font-bold px-8 h-10 md:h-12 text-base" disabled={form.formState.isSubmitting}>
